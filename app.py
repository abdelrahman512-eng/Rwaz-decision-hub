...
.section-title {
    ...
    .combined-card { padding:8px 11px; }
    .combined-header { border-bottom:1px solid #EFE9E2; padding-bottom:5px; margin-bottom:6px; }
    .combined-title { font-size:10px; color:var(--rwaz-mid); font-weight:800; }
    .combined-value { font-size:19px; color:var(--rwaz-text); font-weight:900; font-variant-numeric:tabular-nums; }
    .combined-sub { font-size:9.5px; color:var(--rwaz-primary); font-weight:700; }
    .mini-cell { background:#FBF9F7; border:1px solid #EEE6DD; border-radius:7px; padding:5px 7px; text-align:right; }
    .gauge-bar-bg { background:#ECE6DF; border-radius:10px; height:9px; width:100%; overflow:hidden; margin-top:7px; }
